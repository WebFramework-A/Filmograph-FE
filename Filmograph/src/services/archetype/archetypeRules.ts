...
export const ARCHETYPE_RULES: ArchetypeRule[] = [
  {
    ...
    name: "히어로",
    description:
      "위기에서 앞장서고, 자신을 희생해서라도 타인을 지키려는 중심 인물. 정의와 책임감으로 이야기를 이끄는 전형적인 주인공형 캐릭터.",
    keywords: [
      "영웅",
      "히어로",
      "주인공",
  ...
  },
  {
    ...
    name: "악당",
    description:
      "욕망과 권력, 파괴를 따라 움직이며 주인공과 정면으로 대립하는 인물. 질서를 무너뜨리고 혼란을 일으키는 강렬한 빌런 타입.",
    keywords: [
      "악당",
      "빌런",
      "악의",
  ...
  },
  {
    ...
    name: "아웃사이더",
    description:
      "집단 안에 있지만 끝까지 섞이지 못하고 겉도는 인물. 소외와 고독을 안고 있으나, 그만의 시선과 균열로 이야기에 다른 결을 만들어낸다.",
    keywords: [
      "소외",
      "왕따",
      "외톨이",
  ...
  },
  {
    ...
    name: "브레인",
    description:
      "지능과 분석, 전략으로 판을 짜는 두뇌형 인물. 직접 싸우기보다 계획·설계·정보로 상황을 유리하게 이끄는 전략가 타입.",
    keywords: [
      "천재",
      "머리가 좋",
      "머리가 비상",
  ...
  },
  {
    ...
    name: "탐험가",
    description:
      "익숙한 곳을 벗어나 새로운 세계와 경계를 향해 나아가는 인물. 위험과 변화를 감수하면서 미지의 장소와 경험을 좇는 모험가 타입.",
    keywords: [
      "모험",
      "탐험",
      "원정",
  ...
  },
  {
    ...
    name: "캔디",
    description:
      "밝고 긍정적인 에너지로 주변 분위기를 환하게 만드는 인물. 상처나 고민이 있어도 특유의 낙천성과 사랑스러움으로 사람들을 끌어당기는 타입.",
    keywords: [
      "밝다",
      "명랑",
      "긍정",
  ...
  },
  {
    ...
    name: "마법사",
    description:
      "세계의 규칙과 비밀을 이해하고, 주인공을 이끌거나 시험하는 지혜로운 인물. 실제 마법을 쓰지 않아도 멘토·조언자의 위치에 선다면 이 타입으로 볼 수 있다.",
    keywords: [
      "마법",
      "주술",
      "마도사",
