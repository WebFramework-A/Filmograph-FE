  ...
  return (
    <div className="w-full h-screen snap-start bg-yellow-200 text-[#0d5a5a] flex flex-col justify-center font-serif overflow-hidden">
      ...
      <ScrollReveal direction="right" delay="delay-700">
        <div className="w-full flex justify-end mb-24 md:mb-25 lg:mb-40">
      ...
      {/* FilmoGraph  */}
      <ScrollReveal direction="up" duration="duration-1600" delay="delay-1000">
        <div className="w-full lg:mb-40">
          <div className="w-full h-px bg-[#0b4747]"></div>
