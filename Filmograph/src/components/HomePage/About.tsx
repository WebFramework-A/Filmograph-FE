...
const About = () => {
  return (
    <div className="w-full min-h-screen bg-[#0b4747] flex flex-col items-center snap-start">
      {/* About 위에 줄 */}
      ...
      <div className="relative w-full max-w-4xl flex flex-col pb-20">
        ...
        <div className="w-full flex justify-start mt-40">
          <div className="w-1/2 pr-12 text-right">
            <ScrollReveal direction="left">
              <p className="text-yellow-100 text-2xl font-light leading-relaxed">
                우리는 영화를 단순히
                <br />
                ‘보는’ 대상이 아닌
              </p>
        ...
        <div className="w-full flex justify-center pt-20 pb-10">
          <div className="bg-[#0b4747] z-10 px-4 text-center">
            <ScrollReveal direction="up">
              <p className="text-yellow-100 text-xl py-3 font-light leading-relaxed">
                사용자가 직접 영화 세계를 탐구하고
                <br />
                해석할 수 있는 경험을 제공합니다.
              </p>
