      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 md:mb-14">
          <div className="flex justify-between items-end border-b border-white/20 pb-4 mb-8">
            <h1 className="text-4xl font-bold text-yellow-200">Box Office - Top10</h1>
            <p className="text-sm text-white/70">주간 박스오피스 데이터 확인해보세요.</p>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto">
            <div className="bg-[#004D4F]/50 backdrop-blur-sm border border-white/10 rounded-lg p-8">
            {loading ? (
                ...
                <>
                    ...
                    <Bar dataKey="value" radius={[8, 8, 0, 0]} stroke="none">
                        ...
                        <Cell key={index} fill="#00D4D8" opacity={0.9} stroke="none" />
                        ))}
                    </Bar>
                    </BarChart>
                </>
        ...
        <section className="px-6 pb-16">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-3xl mb-8 text-white">전체 목록</h2>
